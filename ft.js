...
"!лошара", "!лох", "!сучара", "!и че", "!и чо", "!корды", "!корды дай", "!coords", "!ezzz", "!pve bot", "!нубяра", "!в нулину", "!нулевый", "!изич", "!изичка", "!2x1", "!3x1...", "!езки", "!а как подать заявку?"];
...
updateMaxBots() {
    ...
    if (hours < 1) {
        this.state.maxConcurrentBots = 44;
    } else if (hours < 2) {
        this.state.maxConcurrentBots = 38;
    } else if (hours < 5) {
        this.state.maxConcurrentBots = 28;
    } else if (hours < 6) {
        this.state.maxConcurrentBots = 24;
    } else if (hours < 7) {
        this.state.maxConcurrentBots = 18;
    } else if (hours < 8) {
        this.state.maxConcurrentBots = 32;
    } else if (hours < 9) {
        this.state.maxConcurrentBots = 30;
    } else if (hours < 10) {
        this.state.maxConcurrentBots = 40;
    } else if (hours < 11) {
        this.state.maxConcurrentBots = 44;
    } else if (hours < 12) {
        this.state.maxConcurrentBots = 68;
    } else if (hours < 13) {
        this.state.maxConcurrentBots = 78;
    } else if (hours < 14) {
        this.state.maxConcurrentBots = 90;
    } else if (hours < 15) {
        this.state.maxConcurrentBots = 78;
    } else if (hours < 16) {
        this.state.maxConcurrentBots = 80;
    } else if (hours < 17) {
        this.state.maxConcurrentBots = 76;
    } else if (hours < 18) {
        this.state.maxConcurrentBots = 64;
    } else if (hours < 19) {
        this.state.maxConcurrentBots = 58;
    } else if (hours < 20) {
        this.state.maxConcurrentBots = 48;
    } else if (hours < 21) {
        this.state.maxConcurrentBots = 38;
    } else if (hours < 22) {
